...
class NgoProvider extends ChangeNotifier {
  ...
  void addNgo() {
    ...
    if (ngoName.text.isNotEmpty &&
        ngoDesc.text.isNotEmpty &&
        ngoEmail.text.isNotEmpty &&
        ngoPass.text.isNotEmpty) {
      _confirmAddNgo();
    } else {
      Prompts.showSnackBar(context, "Please fill all the fields");
    }
  }
